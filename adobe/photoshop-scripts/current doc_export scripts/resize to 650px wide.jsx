...
var newdoc = app.activeDocument.duplicate(docName + "_650px" , true)

newdoc.resizeImage(650, null, 72, ResampleMethod.BICUBICAUTOMATIC);
...
function saveJPG(saveFile, jpegQuality){
    var saveFile = File(CurrentPath + "/" + docName + "_650px.jpg")
