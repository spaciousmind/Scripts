...
var newdoc = app.activeDocument.duplicate(docName + "_1000px" , true)

newdoc.resizeImage(1000, null, 72, ResampleMethod.BICUBICAUTOMATIC);
...
function saveJPG(saveFile, jpegQuality){
    var saveFile = File(CurrentPath + "/" + docName + "_1000px.jpg")
