...
function savePSD_flat(saveFile, jpegQuality){
   var saveFile = File( outputFolder + "/" + docName + "_flat.psd");
   // PSDSaveOptions = new photoshopSaveOptions;
   // PSDSaveOptions.layers = true;
    psdSaveOptionsFlat = new PhotoshopSaveOptions();


  //  psdSaveOptions = new photoshopSaveOptions()
    psdSaveOptionsFlat.layers = false;

    activeDocument.saveAs(saveFile, psdSaveOptionsFlat, true, Extension.LOWERCASE);
//        activeDocument.close(SaveOptions.DONOTSAVECHANGES)
