...
var newdoc = app.activeDocument.duplicate(docName + "_96dpi" , true)

newdoc.resizeImage(null, null, 96, ResampleMethod.NONE);
...
function saveJPG(saveFile, jpegQuality){
    var saveFile = File(CurrentPath + "/" + docName + "_96dpi.jpg")
