...
function main ()
    {
    var prepscript = File(scriptFolder()+"/preptext.jsx");
    if (prepscript.exists)
        {
        neutraliseStyles (app.activeDocument);
        app.doScript (prepscript);
        restoreStyles (app.activeDocument);
        }
    else
         alert ("Cannot find 'preptext.jsx'.");
