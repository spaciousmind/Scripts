...
var undoName = "align object with first selection"
app.doScript(main, ScriptLanguage.JAVASCRIPT, undefined, UndoModes.ENTIRE_SCRIPT, undoName)
...
function main()
{
	...
	obj[i].move( undefined, [target - getPosition(obj[i],source_align), 0], true );
