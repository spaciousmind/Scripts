...
var column9 = app.selection[0].columns[8]
...
column3.leftInset = 0;
column3.rightInset = 0;

column4.width = 20.5;
column4.cells.everyItem().texts.everyItem().justification = Justification.CENTER_ALIGN;
column4.leftInset = 0;
column4.rightInset = 0;

column5.width = 19.5;
column5.cells.everyItem().texts.everyItem().justification = Justification.RIGHT_ALIGN;
column5.rightInset = 3;
...
column7.width = 21.5;
column7.cells.everyItem().texts.everyItem().justification = Justification.LEFT_ALIGN;
column7.leftInset = 0;
column7.rightInset = 0;

column8.width = 16.5;
column8.cells.everyItem().texts.everyItem().justification = Justification.CENTER_ALIGN;
column8.leftInset = 0;
column8.rightInset = 0;

column9.width = 19;
column9.cells.everyItem().texts.everyItem().justification = Justification.RIGHT_ALIGN;
column9.leftInset = 0;
column9.rightInset = 3;
