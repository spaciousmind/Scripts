function checkWhichTable() {    //ensure user made a selection
 ...
 a++) processTable(allTables[a]);
  ...
  app.changeGrepPreferences.appliedCharacterStyle = app.activeDocument.characterStyleGroups.item("2019 styles").characterStyleGroups.item("TABLES").characterStyles.item("interfit sizes");
 ...
 // flatten array
  ...
  while (l--) {
      row = changes[l].parent.parentRow.cells.everyItem();
          ...
          row.appliedCellStyle = "interfit size cells";
          row.bottomEdgeStrokeWeight = .5;
          row.bottomEdgeStrokeColor = "INTERFIT BLUE";
